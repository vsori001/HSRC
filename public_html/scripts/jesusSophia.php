<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Jesus Sophia: Wisdom Of God 2/1/14'; 
      ...
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for Jesus Sophia: Wisdom of God</strong><br/>
		...
		<div id="php-header-intro">
			Jesus Sophia:<br/>
			Wisdom of God<br />
			February 1, 2014 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="jesusSophia.php" method="post" id="events-form-lunch">
