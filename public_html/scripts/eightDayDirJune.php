<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for 8-Day Directed Retreat 6/15/14 - 6/22/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by June 1, 2014.<br /><br />
			<b>Thank you for registering for the 8-Day Directed Retreat.</b><br /><br />
		...
		<div id="php-header-intro">
			8-Day Directed Retreat<br />
			**Private Bedrooms Only - $500**<br />
			June 15, 2014 5:00pm -<br />
			June 22, 2014 1:00pm<br />
		</div>
		<form action="eightDayDirJune.php" method="post" id="events-form-weekend">
