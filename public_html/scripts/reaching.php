<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Reaching High: Digging Deep Retreat 1/5/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit with registration is due on January 2, 2013.<br /><br />
			<b>Thank you for registering for the<br/>
			Reaching High: Digging Deep Retreat.</b>
		...
		<div id="php-header-intro">
			Reaching High: Digging Deep:<br />
			The Possibilities of Epiphany<br/>
			January 5, 2013 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="reaching.php" method="post" id="events-form-lunch">
