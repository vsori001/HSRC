<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Image and Imagination Retreat 10/27/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is requested by October 22, 2012.<br /><br />
			<b>Thank you for registering for Image and Imagination.</b>
		...
		<div id="php-header-intro">
			Image and Imagination:<br />
			Honoring a Transformative<br/>
			Spiritual Path<br/>
			October 27, 2012 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch
		</div> 
		<div class="events-form-wrapper">
			<form action="imageImagination.php" method="post" id="events-form-lunch">
