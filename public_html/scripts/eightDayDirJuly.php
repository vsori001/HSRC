<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for 8-Day Directed Retreat 7/20/14 - 7/27/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by July 12, 2014.<br /><br />
		...
		<div id="php-header-intro">
			...
			**Private Bedrooms Only - $500**<br />
			July 20, 2014 5:00pm -<br />
			July 27, 2014 1:00pm<br />
		</div>
