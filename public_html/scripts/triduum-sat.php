<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Meals on Good Friday 4/7/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			Your request for meals has been turned in and will be processed soon.<br /><br />
			<b>Thank you for registering for the meals during<br />
			 our Easter Vigil Service</b>
		...
		<div id="php-header-intro">
			...
			April 7, 2012<br />
			Readings begin at 3:00pm<br />
			Dinner served at 6:00pm<br />
			Vigil begins at 9:00pm<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="triduum-sat.php" method="post" id="events-form-lunch">
