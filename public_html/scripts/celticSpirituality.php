<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Celtic Spirituality 3/9/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by February 22, 2013.<br /><br />
			<b>Thank you for registering for Celtic Spirituality</b>
		...
		<div id="php-header-intro">
			...
			March 9, 2013 9:00am - 3:30pm<br />
			(Arrival 8:30am - 9:00am)<br/>
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="celticSpirituality.php" method="post" id="events-form-lunch">
