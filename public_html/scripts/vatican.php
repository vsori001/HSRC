<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Vatican II Revisited 3/2/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by February 20, 2013.<br /><br />
			<b>Thank you for registering for Vatican II Revisited</b>
		...
		<div id="php-header-intro">
			Vatican II Revisited:<br />
			A Conversation<br/>
			March 2, 2013 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="vatican.php" method="post" id="events-form-lunch">
