<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for 8-Day Directed Retreat 2 7/28/13 - 8/4/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by July 12, 2013.<br /><br />
			<b>Thank you for registering for the 8-Day Directed Retreat 2.</b><br /><br />
		...
		<div id="php-header-intro">
			8-Day Directed Retreat 2<br />
			**Private Bedrooms Only - $500**<br />
			July 28, 2013 5:00pm -<br />
			August 4, 2013 1:00pm<br />
		</div>
		<form action="eightDayDir2.php" method="post" id="events-form-weekend">
