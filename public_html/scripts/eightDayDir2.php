<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for 8-Day Directed Retreat 7/26/15 - 8/2/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by June 15, 2015.<br /><br />
		...
		<div id="php-header-intro">
			...
			**Private Bedrooms Only - $500**<br />
			July 26, 2015 5:00pm -<br />
			August 2, 2015 1:00pm<br />
		</div>
