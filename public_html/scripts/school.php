<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The School of the Lord&#8217;s Prayer 2/2/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by January 22, 2013.<br /><br />
			<b>Thank you for registering for The School of the Lord&#8217;s Prayer</b>
		...
		<div id="php-header-intro">
			The School of the Lord&#8217;s Prayer<br />
			&ldquo;Prayer is a cry of hope&hellip;&rdquo;<br/>
			February 2, 2013 9:00am - 4:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="school.php" method="post" id="events-form-lunch">
