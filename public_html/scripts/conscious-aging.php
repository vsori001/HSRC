<?php 
	$retreat = "Conscious Aging: Make A choice! 11/21/15";
?>
<html>	
	...
	<body class="signup">
      ...
      <div id="php-header-intro">
        <img src="../img/events/2015/november/conscious-aging/conscious-aging.gif" width="600" height="552" /> 
      </div> 
      <form action="conscious-aging.php" method="post">
