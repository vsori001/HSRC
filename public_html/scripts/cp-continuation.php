<html>	
	<head>
		...
		<title>Continuation of the Centering Prayer Introductory Workshop</title>
  </head>
	<body id="leaves">
		<?php 
		if ($_POST["email"]<>'') { 
			$ToEmail = 'hsrcenter@earthlink.net'; 
			$EmailSubject = 'Registration for Continuation of the Centering Prayer Introductory Workshop 2/14/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for the Continuation of the<br/>
      Centering Prayer Introductory Workshop</b>
		...
		<div id="php-header-intro">
			Continuation of the Centering Prayer<br/>
      Introductory Workshop<br />
			February 14, 2015 9:00am - 2:00pm<br />
			$35 with lunch // $25 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="cp-continuation.php" method="post" id="events-form-lunch">
