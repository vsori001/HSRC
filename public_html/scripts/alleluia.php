<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for ADT Dance Workshop 1/19/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by January 14, 2013.<br /><br />
			<b>Thank you for registering for ADT Dance Workshop</b>
		...
		<div id="php-header-intro">
			ADT Dance Workshop<br />
			HOPE: Dispelling Fear<br/>
			January 19, 2012 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="alleluia.php" method="post" id="events-form-lunch">
