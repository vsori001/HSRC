<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Speaking in Tongues of Dance 4/11/15'; 
      ...
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for Sacred Collage</strong><br/>
		...
		<div id="php-header-intro">
			Speaking in Tongues of Dance<br />
			April 11, 2015 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="speakingTongues.php" method="post" id="events-form-lunch">
