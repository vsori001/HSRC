<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Simplicity: The Souls Refreshment 1/10/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Simplicity: The Soul's Refreshment</b>
		...
		<div id="php-header-intro">
			Simplicity: The Soul's Refreshment<br />
			January 10, 2015 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="simplicity.php" method="post" id="events-form-lunch">
