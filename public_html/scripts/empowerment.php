<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Empowerment of the Holy Spirit 3/28/14 - 3/30/14'; 
			...
			$MESSAGE_BODY .= "Single, Shared, Commuter?: ".$_POST["room"]."<br>";
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for the Empowerment of the Holy Spirit Retreat.</b><br /><br />
      ...
      Holy Spirit<br/>
			March 28, 2014 5:00pm -<br />
			March 30, 2014 1:00pm<br />
		</div>
		<form action="empowerment.php" method="post" id="events-form-weekend">
			<table width="450" border="0" cellpadding="3" id="events-table">
				...
				<tr>
					<td class="events-bodytext">
						...
						<input name="room" type="radio" value="Single Room">Single Room ($250)<br/>
