<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Rumi: Mystic For the 21st Century 2/15/14'; 
      ...
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for Rumi: Mystic for the 21st Century</strong><br/>
		...
		<div id="php-header-intro">
			Rumi: Mystic for<br/>
			the 21st Century<br />
			February 15, 2014 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="rumi.php" method="post" id="events-form-lunch">
