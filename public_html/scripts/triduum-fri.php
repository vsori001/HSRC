<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Meals on Good Friday 4/6/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for the meals on Good Friday</b>
		...
		<div id="php-header-intro">
			Triduum: Good Friday<br />
			April 6, 2012<br />
			Stations of the Cross - 10:30am<br />
			Lunch - 12:00pm<br />
			Liturgy - 3:00pm<br />
			Dinner - 5:30pm<br />
			Taize Prayer - 7:30pm<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="triduum-fri.php" method="post" id="events-form-lunch">
