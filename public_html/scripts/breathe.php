<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Breathe In Me 1/31/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due when you by January 20.<br /><br />
			<b>Thank you for registering for Breathe In Me</b>
		...
		<div id="php-header-intro">
			Breathe In Me, O Holy Spirit and<br />
      Move In Me<br/>
			January 31, 2015 9:15am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="breathe.php" method="post" id="events-form-lunch">
