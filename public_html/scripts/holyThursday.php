<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Reservation for Holy Thursday 3/28/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for reserving for Holy Thursday</b>
		...
		<div id="php-header-intro">
			...
			March 28, 2013 6:00pm<br />
			Fee: $25 <br />
		</div> 
		<div class="events-form-wrapper">
			<form action="holyThursday.php" method="post" id="events-form-lunch">
