<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Writing with the Spirit'; 
			...
			$MESSAGE_BODY .= "Dates: ";
			$MESSAGE_BODY .= "<br>".$_POST["apr4"]." ".$_POST["apr11"]." ".$_POST["apr18"]." ".$_POST["apr25"]." ".$_POST["may2"]." ".$_POST["may9"]." ";
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Writing with the Spirit.</b><br /><br />
		...
		<div id="php-header-intro">
			Writing with the Spirit<br />
			$15 per session<br/>
			or $75 for 6 sessions
		</div>
		<form action="writing.php" method="post" id="events-form-weekend">
			<table width="450" border="0" cellpadding="3" id="events-table">
				...
				<tr>
					<td class="events-bodytext">
						...
						<input type="checkbox" name="apr4" value="April 4" />April 4<br/>
						<input type="checkbox" name="apr11" value="April 11" />April 11<br/>
						<input type="checkbox" name="apr18" value="April 18" />April 18<br/>
						<input type="checkbox" name="apr25" value="April 25" />April 25<br/>
						<input type="checkbox" name="may2" value="May 2" />May 2<br/>
						<input type="checkbox" name="may9" value="May 9" />May 9<br/>
					</td>
				</tr>
				<tr>
