<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Holy Spirit, Life, Breath of the Church 4/26/13 - 4/28/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by April 15, 2013.<br /><br />
			<b>Thank you for registering for &ldquo;The Holy Spirit, Life,<br/>
			Breath of the Church&rdquo;</b><br /><br />
		...
		<div id="php-header-intro">
			&ldquo;The Holy Spirit, Life,<br />
			Breath of the Church&rdquo;<br/>
			April 26, 2013 5:00pm -<br />
			April 28, 2013 1:00pm<br />
		</div>
		<form action="holySpirit.php" method="post" id="events-form-weekend">
