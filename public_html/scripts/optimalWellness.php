<html>	
	<head>
		...
		<title>Wellness Conversation with Dr. Arnel</title>
  </head>
	<body id="leaves" class="php-body">
		<?php 
		if ($_POST["email"]<>'') { 
			$ToEmail = 'hsrcenter@earthlink.net'; 
			$EmailSubject = 'Registration for Wellness Conversation 10/25/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Wellness Conversation with Dr. Arnel.</b><br /><br />
		...
		<div id="php-header-intro">
			...
			with Dr. Arnel<br />
			October 25, 2014 9:00am - 3:00pm<br />
		</div>
		<form action="optimalWellness.php" method="post" id="events-form-weekend">
