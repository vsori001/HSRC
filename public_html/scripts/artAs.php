<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Art as Sacred Expression 6/16/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Art as Sacred Expression</b>
			A $10 deposit is due by June 11, 2012.<br /><br />
		...
		<div id="php-header-intro">
			Art as Sacred Expression<br />
			June 16, 2012 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="artAs.php" method="post" id="events-form-lunch">
