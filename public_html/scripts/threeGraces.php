<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Three Graces Retreat 9/29/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			due on or before September 22, 2012.<br /><br />
			<b>Thank you for registering for The Three Graces Retreat</b>
		...
		<div id="php-header-intro">
			The Three Graces<br />
			September 29, 2012 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="threeGraces.php" method="post" id="events-form-lunch">
