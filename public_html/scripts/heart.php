<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Communication from the heart 2/4/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			Full payment or a $10 deposit is due by January 30, 2012.<br /><br />
			<b>Thank you for registering for Communication from the Heart</b>
		...
		<div id="php-header-intro">
			Communication from the Heart<br />
			February 4, 2012 10:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="heart.php" method="post" id="events-form-lunch">
