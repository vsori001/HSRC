<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The New Evangelization 5/25/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by May 15, 2013.<br /><br />
			<b>Thank you for registering for The New Evangelization Retreat</b>
		...
		<div id="php-header-intro">
			The New Evangelization<br />
			What in Our World...?<br/>
			May 25, 2013 9:00am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="newEvangelization.php" method="post" id="events-form-lunch">
