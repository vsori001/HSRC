<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Sit Like A Mountain 3/1/14'; 
      ...
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for &ldquo;Sit Like a Mountain&rdquo; &hellip;</strong><br/>
		...
		<div id="php-header-intro">
			&ldquo;Sit Like a Mountain&rdquo;&hellip;<br />
			March 1, 2014 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="sitLikeAMountain.php" method="post" id="events-form-lunch">
