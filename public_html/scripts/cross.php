<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for A Day with John of the Cross, Poet, and Mystic 3/10/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by March 5, 2012.<br /><br />
			<b>Thank you for registering for A Day with John of the Cross,<br />
			Poet, and Mystic</b>
		...
		<div id="php-header-intro">
			A Day with John of the Cross,<br />
			Poet, and Mystic<br />
			March 10, 2012 9:00am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="cross.php" method="post" id="events-form-lunch">
