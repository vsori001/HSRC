<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Be Fit . . . Be Well'; 
			...
			$MESSAGE_BODY .= "Dates: ";
			$MESSAGE_BODY .= "<br>".$_POST["sep11"]." ".$_POST["sep18"]." ".$_POST["sep25"]." ".$_POST["oct2"]." ".$_POST["oct9"]." ".$_POST["oct16"]." ";
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Be Fit . . . Be Well</b><br /><br />
		...
		<form action="beFit.php" method="post" id="events-form-weekend">
			<table width="450" border="0" cellpadding="3" id="events-table">
				...
				<tr>
					<td class="events-bodytext">
						...
						<input type="checkbox" name="sep11" value="September 11" />September 11<br/>
						<input type="checkbox" name="sep18" value="September 18" />September 18<br/>
						<input type="checkbox" name="sep25" value="September 25" />September 25<br/>
						<input type="checkbox" name="oct2" value="October 2" />October 2<br/>
						<input type="checkbox" name="oct9" value="October 9" />October9<br/>
						<input type="checkbox" name="oct16" value="October 16" />October 16<br/>
					</td>
				</tr>
				<tr>
