<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Imago Dei: Discovering the Christ Within 1/17/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Imago Dei: Discovering the Christ Within</b>
		...
		<div id="php-header-intro">
			Imago Dei:<br/>
      Discovering the Christ Within<br />
			January 17, 2015 9:00am - 4:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="imagodei.php" method="post" id="events-form-lunch">
