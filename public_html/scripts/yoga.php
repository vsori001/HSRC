<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Spiritual Journey and Yoga 6/6/15'; 
      ...
      A $10 Deposit is due at the time of registration.<br />
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for Your Spiritual Journey and Yoga</strong><br/>
		...
		<div id="php-header-intro">
			Your Spiritual Journey and Yoga<br />
			June 6, 2015 9:00am - 4:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="yoga.php" method="post" id="events-form-lunch">
