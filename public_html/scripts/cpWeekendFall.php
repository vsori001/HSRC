<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Centering Prayer Weekend Retreat 10/25/13 - 10/27/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by December 15, 2013.<br /><br />
		...
		<div id="php-header-intro">
			...
			October 22, 2013 5:00pm -<br />
			October 24, 2013 1:00pm<br />
		</div>
		<form action="cpWeekendFall.php" method="post" id="events-form-weekend">
