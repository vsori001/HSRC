<?php 
	$retreat = "Wellness Day: A Conversation With Dr. Arnel Reyes 10/17/15";
?>
<html>	
	...
	<body class="signup">
      ...
      <div id="php-header-intro">
        <img src="../img/events/2015/october/wellness/wellness.gif" width="600" height="507" />
      </div> 
      <form action="wellness.php" method="post">
