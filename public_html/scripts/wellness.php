<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Wellness and Spirituality Part 2 12/8/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by December 3, 2012.<br /><br />
			<b>Thank you for registering for Wellness and Spirituality Part 2</b>
		...
		<div id="php-header-intro">
			Wellness and Spirituality Part 2<br />
			December 8, 2012 9:00am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="wellness.php" method="post" id="events-form-lunch">
