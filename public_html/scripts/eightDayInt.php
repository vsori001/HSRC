<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for 8-Day Intensive & Post-Intensive Centering Prayer Retreats 6/30/13 - 7/7/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by June 1, 2013.<br /><br />
			<b>Thank you for registering for the 8-Day Intensive<br />
			& Post-Intensive Centering Prayer Retreats.</b><br /><br />
		...
		<div id="php-header-intro">
			8-Day Intensive & Post-Intensive<br />
			Centering Prayer Retreats<br />
			**Private Bedrooms Only - $500**<br />
			June 30, 2013 5:00pm -<br />
			July 7, 2013 1:00pm<br />
		</div>
