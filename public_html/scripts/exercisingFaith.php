<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Exercising Your Faith 09/13/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			Full payment OR a $10 deposit with registration.<br /><br />
			<b>Thank you for registering for the Exercising Your Faith Retreat</b>
		...
		<div id="php-header-intro">
			Exercising Your Faith<br />
			September 13, 2014 9:00am - 4:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="exercisingFaith.php" method="post" id="events-form-lunch">
