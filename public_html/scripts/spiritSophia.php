<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Spirit Sophia 4/6/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by March 20, 2013.<br /><br />
			<b>Thank you for registering for Spirit Sophia</b>
		...
		<div id="php-header-intro">
			Spirit Sophia: Reflecting on the<br />
			Feminine Aspects of God<br/>
			April 6, 2013 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="spiritSophia.php" method="post" id="events-form-lunch">
