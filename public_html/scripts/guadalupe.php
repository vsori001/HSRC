<?php 
	$retreat = "Celebrating The Feast of Our Lady of Guadalupe: Mary Did You Know? ...And The Jubilee Year Of Mercy 12/12/15";
?>
<html>	
	...
	<body class="signup">
      ...
      <div id="events-returnpg">
        ...
        A $10 deposit is due by December 7, 2015.<br /><br />
      ...
      <div id="php-header-intro">
        <img src="../img/events/2015/december/guadalupe/guadalupe.gif" width="600" height="451" /> 
      </div> 
      <form action="guadalupe.php" method="post">
