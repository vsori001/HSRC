<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Reservation for Good Friday Lunch 3/29/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for reserving for Good Friday</b>
		...
		<div id="php-header-intro">
			...
			March 29, 2013 10:00am<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="goodFriday.php" method="post" id="events-form-lunch">
