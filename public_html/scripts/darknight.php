<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Dark Night of the Soul 2/21/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due February 15, 2015.<br /><br />
			<b>Thank you for registering for the Dark Night of the Soul</b>
		...
		<div id="php-header-intro">
			...
			February 21, 2015 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="darknight.php" method="post" id="events-form-lunch">
