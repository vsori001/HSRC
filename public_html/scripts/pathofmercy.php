<html>	
	<head>
		...
		<title>Wellness Weekend</title>
  </head>
	<body id="leaves" class="php-body">
		<?php 
		if ($_POST["email"]<>'') { 
			$ToEmail = 'hsrcenter@earthlink.net'; 
			$EmailSubject = 'Registration for Path Of Mercy 12/30/14 - 1/1/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $50 deposit is due by December 15, 2014.<br /><br />
			<b>Thank you for registering for Path of Mercy.</b><br /><br />
		...
		<div id="php-header-intro">
			Path of Mercy<br />
			December 30, 2014 2:00pm -<br />
			January 1, 2015 10:30am<br />
		</div>
		<form action="pathofmercy.php" method="post" id="events-form-weekend">
			<table width="450" border="0" cellpadding="3" id="events-table">
				...
				<tr>
					<td class="events-bodytext">
						...
						<input name="room" type="radio" value="Private Room">Private Room ($250)<br/>
