<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for A Window into Native American Spirituality 11/10/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			Full payment OR a $10 deposit with registration is<br/>
			due on or before November 5, 2012.<br /><br />
			<b>Thank you for registering for A Window Into Native<br/>
			American Spirituality</b>
		...
		<div id="php-header-intro">
			...
			November 10, 2012 9:30am - 4:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="nativeAmerican.php" method="post" id="events-form-lunch">
