<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for a Day of Silent Reflection Retreat 5/5/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by April 30, 2012.<br /><br />
			<b>Thank you for registering for a Day of Silent Reflection</b>
		...
		<div id="php-header-intro">
			Day of Silent Reflection<br />
			May 5, 2012 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="silentRe.php" method="post" id="events-form-lunch">
