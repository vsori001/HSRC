<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Centering Prayer Community Day 8/8/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<strong>Thank you for registering for Centering Prayer Community Day</strong><br/>
		...
		<div id="php-header-intro">
			Centering Prayer Community Day<br />
			August 8, 2015 8:30am - 2:30pm<br />
			Free will offering<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="communityDay.php" method="post" id="events-form-lunch">
