<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Pace E. Bene 10/04/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Pace E. Bene</b>
		...
		<div id="php-header-intro">
			Pace E. Bene<br />
      Celebrating the Feast of St. Francis<br/>
			October 4, 2014 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="paceEBene.php" method="post" id="events-form-lunch">
