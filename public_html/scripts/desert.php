<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Desert Shall Rejoice and Blossom 2/13/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by Feruary 6, 2013.<br /><br />
			<b>Thank you for The Desert Shall Rejoice and Blossom....</b>
		...
		<div id="php-header-intro">
			&ldquo;The Desert Shall Rejoice<br />
			and Blossom....&rdquo;<br/>
			February 13, 2013 9:30am - 3:30pm<br />
			(Arrival 9:00am)<br/>
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="desert.php" method="post" id="events-form-lunch">
