<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Praying With Color Retreat 4/13/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			$10 deposit with registration is<br/>
			due on or before April 1, 2032.<br /><br />
			<b>Thank you for registering for the Praying with Color Retreat</b>
		...
		<div id="php-header-intro">
			Praying with Color<br />
			April 13, 2013 9:00am - 4:00pm<br />
			$55 with lunch // $45 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="prayingWithColor.php" method="post" id="events-form-lunch">
