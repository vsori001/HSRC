<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Holy Thursday 4/5/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $25 fee is due by April 2, 2012.<br /><br />
			<b>Thank you for registering for our Holy Thursday services</b>
		...
		<div id="php-header-intro">
			Triduum: Holy Thursday<br />
			April 5, 2012 6:00pm<br />
			$25 fee for liturgy and meal<br />
		</div> 
