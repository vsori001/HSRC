<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$MESSAGE_BODY .= "Dates: ";
			$MESSAGE_BODY .= "<br>".$_POST["mar11"]." ".$_POST["apr13"]." ".$_POST["may8"]." ";
		...
		<form action="waw.php" method="post" id="events-form-weekend">
            ...
            <?php if( time() < strtotime("04/13/14") ){ 
							echo "<input type=\"checkbox\" name=\"apr13\" value=\"April 13\" />April 13<br/>";
						} ?>
            <?php if( time() < strtotime("05/08/14") ){ 
							echo "<input type=\"checkbox\" name=\"may8\" value=\"May 8\" />May 8<br/>";
						} 
						else{
