<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Women At The Well'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for Women At The Well.</b><br /><br />
		...
		<form action="waw.php" method="post" id="events-form-weekend">
