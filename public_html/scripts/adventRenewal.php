<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for The Advent Day of Renewal 12/15/12'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit with registration is due on December 10, 2012.<br /><br />
			<b>Thank you for registering for The Advent Day of Renewal</b>
		...
		<div id="php-header-intro">
			Advent Day of Renewal<br />
			December 15, 2012 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="adventRenewal.php" method="post" id="events-form-lunch">
