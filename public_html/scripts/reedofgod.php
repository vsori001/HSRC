<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Reed of God 12/20/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due at registration.<br /><br />
			<b>Thank you for registering for Reed of God</b>
		...
		<div id="php-header-intro">
			Reed Of God<br/>
			December 20, 2014 9:30am - 3:00pm<br />
