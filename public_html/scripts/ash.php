<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Ash Wednesday: Day of Prayer 3/5/14'; 
      ...
      Contact the Office Manager to submit a payment.<br/><br />
			<strong>Thank you for registering for &ldquo;Ash Wednesday: Day of Prayer&rdquo; &hellip;</strong><br/>
		...
		<div id="php-header-intro">
			&ldquo;Ash Wednesday: Day of Prayer&rdquo;&hellip;<br />
			March 5, 2014 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="ash.php" method="post" id="events-form-lunch">
