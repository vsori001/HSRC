<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Wrestling with Tension 7/27/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			A $10 deposit is due by July 15, 2013.<br /><br />
			<b>Thank you for registering for Wrestling with Tension</b>
		...
		<div id="php-header-intro">
			Wrestling with Tension<br />
			Henri Nouwen and the Reality<br/>
			of Our Journey<br/>
			July 27, 2013 9:00am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="wrestling.php" method="post" id="events-form-lunch">
