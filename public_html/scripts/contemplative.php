<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Contemplative Outreach 3/23/13'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			Registration is due by March 16, 2013.<br /><br />
			<b>Thank you for registering for COntemplative Outreach</b>
		...
		<div id="php-header-intro">
			...
			March 23, 2013 9:00am - 3:30pm<br />
			$10 with lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="contemplative.php" method="post" id="events-form-lunch">
