<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Encountering God 01/11/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			due on or before January 1, 2014.<br /><br />
			<b>Thank you for registering for Encountering God</b>
		...
		<div id="php-header-intro">
			Encountering God<br />
			January 11, 2014 9:30am - 3:30pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="encounteringGod.php" method="post" id="events-form-lunch">
