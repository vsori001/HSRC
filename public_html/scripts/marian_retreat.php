<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Marian Retreat 5/17/14'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for The Marian Retreat</b><br /><br />
		...
		<div id="php-header-intro">
			Marian Retreat:<br />
      Virgian Mary, Mother of Jesus<br/>
			May 17, 2014<br/>
      9:30am - 3:30pm<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="marian_retreat.php" method="post" id="events-form-lunch">
