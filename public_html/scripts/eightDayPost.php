<html>	
	...
	<body id="leaves" class="php-body">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for the 8-Day Post Intensive Centering Prayer Retreat 6/28/15 - 7/5/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for the 8-Day Post Intensive Centering Prayer Retreat.</b><br /><br />
