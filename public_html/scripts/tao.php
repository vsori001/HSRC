<html>	
	...
	<body id="leaves">
		...
		if ($_POST["email"]<>'') { 
			...
			$EmailSubject = 'Registration for Tao of Pooh: How to Enter the Lenten Doorway 2/18/15'; 
		...
		<div class="events-bodytext" id="events-returnpg">
			...
			<b>Thank you for registering for the Tao of Pooh</b>
		...
		<div id="php-header-intro">
			Tao of Pooh: How to Enter<br/>
      the Lenten Doorway<br/>
			February 18, 2015 9:30am - 3:00pm<br />
			$45 with lunch // $35 without lunch<br />
		</div> 
		<div class="events-form-wrapper">
			<form action="tao.php" method="post" id="events-form-lunch">
